...
spark = SparkSession.builder \
    .appName("Transform Traffic Data") \
    .getOrCreate()

HDFS_BASE_PATH = "hdfs://localhost:9000/user/hdoop/toronto_traffic/input/"

# Define file path
file_path = f"{HDFS_BASE_PATH}tf-ft-eng.csv"  # Update path accordingly
